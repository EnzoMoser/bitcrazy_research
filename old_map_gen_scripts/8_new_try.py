                ...
                if break_loop == False:
                    ...
                    if len(pos_moves) == 0:
                        ...
                        if one_less_break % 2 == 0:
                            # Number is even
                            break_lines_one, break_error, did_a_line_reach_end, no_cross_one = create_line(new_pos_one, cur_pos, break_half, grid_size, temp_lines_one, length, total_len, did_a_line_reach_end, line_fail_lim, no_cross_list)
                            if not break_error:
                                temp_cross_one = no_cross_list
                                temp_cross_one.extend(no_cross_one)
                                temp_lines_one = prev_lines_including_this
                                temp_lines_one.extend(break_lines_one)
                                #print("Cur: ", cur_pos)
                                break_lines_two, break_error, did_a_line_reach_end, no_cross_two = create_line(new_pos_two, cur_pos, break_half, grid_size, temp_lines_two, length, total_len, did_a_line_reach_end, line_fail_lim, no_cross_list)
                        else:
                            # Number is odd
                            #print("Break is odd: ", breaks_needed - 1)
                            break_lines_one, break_error, did_a_line_reach_end, no_cross_one = create_line(new_pos_one, cur_pos, break_ceil, grid_size, temp_lines_one, length, total_len, did_a_line_reach_end, line_fail_lim, no_cross_list)
                            if not break_error:
                                temp_cross_two = no_cross_list
                                temp_cross_two.extend(no_cross_two)
                                temp_lines_two = prev_lines_including_this
                                temp_lines_two.extend(break_lines_two)
