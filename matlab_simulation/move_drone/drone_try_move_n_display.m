function [ torf, new_drone_coord ] = drone_try_move_n_display(go_back_if_unsuccessful, image, drone_coord, drone_radius, time_delay, move_length, move_angle, allowed_colors, drone_color, bad_drone_color)
...
if pixel_valid_area(image, new_drone_coord, drone_radius, allowed_colors)
    ...
    if time_delay > 0; pixel_display_image(new_image, 1); end
    torf = true;
